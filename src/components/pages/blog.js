...
export default class Blog extends Component {
	...
	getBlogItems() {
		...
		axios
			.get(
				`https://spencervp.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`,
				{ withCredentials: true }
			)
			.then((response) => {
				this.setState({
			...
			if (this.props.loggedInStatus === "LOGGED_IN") {
				return (
					<div key={blogItem.id} className="admin-blog">
						...
						<a onClick={() => this.deleteBlog(blogItem)}>
			...
			<div className="blog-container">
				...
				{this.props.loggedInStatus === "LOGGED_IN" ? (
					<div className="new-blog-link">
						<a className="blog-icon" onClick={this.handleNewBlogClick}>
							{" "}
